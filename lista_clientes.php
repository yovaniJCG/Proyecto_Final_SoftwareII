...
$registros = $base->query("SELECT * FROM clientes $where;")->fetchAll(PDO::FETCH_OBJ);
?>
...
<head>
  ...
  <title>Trnsacional Clientes</title>
...
<body>
  ...
  <section class="sec1">
    <div class="max-width">
      <div class="titulo">
      <i class="fas fa-check"></i> <h1>Clientes</h1>
      </div>
...
<div class="max-width">
     <?php 
			...
			?>
					...
					<i class="far fa-check-circle vertical-middle"></i>	 Datos del Cliente Actualizados.
						</div>
				<?php
          ...
          <div class="PEA alert-success">
							<i class="far fa-check-circle vertical-middle"></i> Cliente agregado correctamente.
						</div><br><br><br>
               <?php
        }
      }
      ...
      <table class="display" id="myTable">
        ...
        <?php foreach($registros as $cliente){ ?>
          <tr>
            ...
            <td><a href="<?php echo "Acciones/editar_cliente.php?id=" . $cliente->Id ?>" class="btn_edi"><i class="editar fa fa-edit"></i></a></td>
